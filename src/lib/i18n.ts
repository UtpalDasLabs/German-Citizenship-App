...
const strings = {
  en: {
    ...
    iosStep3: 'Tap “Add” in the top right. The eagle appears on your home screen.',
    iosOtherBrowser: 'First open this page in Safari \u2014 other iPhone browsers cannot do this.',
    androidStep1: 'Tap the three dots menu at the top right of Chrome.',
    androidStep2: 'Tap “Install app”, or “Add to Home screen” on older versions.',
    androidStep3: 'Tap “Install”. The eagle appears on your home screen.',
    desktopStep1: 'Look for the install icon at the end of the address bar.',
    desktopStep2: 'Or open the browser menu and choose “Install LID-test”.',
    installShowSteps: 'Show me how to do it by hand',
    installHideSteps: 'Hide the steps',
  ...
  de: {
    ...
    iosStep1: 'Tippe unten in Safari auf das Teilen-Symbol \u2014 das Quadrat mit dem Pfeil.',
    iosStep2: 'Scrolle in der Liste nach unten und tippe auf „Zum Home-Bildschirm“.',
    iosStep3: 'Tippe oben rechts auf „Hinzufügen“. Der Adler erscheint auf deinem Startbildschirm.',
    iosOtherBrowser: 'Öffne diese Seite zuerst in Safari \u2014 andere iPhone-Browser können das nicht.',
    androidStep1: 'Tippe oben rechts in Chrome auf das Menü mit den drei Punkten.',
    androidStep2: 'Tippe auf „App installieren“, in älteren Versionen auf „Zum Startbildschirm hinzufügen“.',
    androidStep3: 'Tippe auf „Installieren“. Der Adler erscheint auf deinem Startbildschirm.',
    desktopStep1: 'Suche das Installieren-Symbol am Ende der Adressleiste.',
    desktopStep2: 'Oder öffne das Browsermenü und wähle „LID-test installieren“.',
    installShowSteps: 'Zeig mir, wie es von Hand geht',
    installHideSteps: 'Schritte ausblenden',
    maybeLater: 'Später',
